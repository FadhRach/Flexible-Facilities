...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <a href="/response" class="flex mb-5 justify-center mr-6">
    ...
    <ul class="space-y-2 font-medium">
        <li>
            <a href="/response" class="flex items-center ml-1 p-2 text-gray-50 rounded-lg dark:text-white hover:bg-[#5C5470] dark:hover:bg-[#5C5470] group">
                <img src="{{ asset('img/logo-response.gif') }}" alt="" class="h-7">
                <span class="flex-1 ml-3 whitespacea-nowrap">Response</span>
            </a>
        </li>
    </ul>
    ...
    <ul class="space-y-2 font-medium">
        <li>
            <a href="/permohonan" class="flex items-center ml-1 p-2 text-gray-50 rounded-lg dark:text-white hover:bg-[#5C5470] dark:hover:bg-[#5C5470] group">
                <img src="{{ asset('img/logo-per.gif') }}" alt="" class="h-7">
    ...
    <ul class="pt-1 mt-10 space-y-2 font-medium">
        <li>
            <a href="/pinjamuser" class="flex items-center ml-1 p-2 text-gray-50 rounded-lg dark:text-white hover:bg-[#5C5470] dark:hover:bg-[#5C5470] group">
        ...
        <li>
            <a href="/lihatdata" class="flex items-center ml-1 p-2 text-gray-50 rounded-lg dark:text-white hover:bg-[#5C5470] dark:hover:bg-[#5C5470] group">
                    <img src="{{ asset('img/logo-arsipdokumen.gif') }}" alt="" class="h-7">
                <span class="flex-1 ml-3 whitespace-nowrap">Lihat Data.</span>
            </a>
        </li>
        <li>
            <a href="/profile/{{ Auth::user()->id_user }}" class="flex items-center ml-1 p-2 text-gray-50 rounded-lg dark:text-white hover:bg-[#5C5470] dark:hover:bg-[#5C5470] group">
