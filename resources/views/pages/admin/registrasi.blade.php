            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" method="post" action="/registrasi/simpan"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                                <img class="h-44 rounded-full mb-5 border border-purple-900 p-2" id="imagePreview"
                                    src="https://i.pinimg.com/736x/b1/57/5f/b1575fa57160fd2ff62a44b62201d866.jpg"
                                    alt="Placeholder Image">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                    for="user_avatar">Tambahkan Profile</label>
                                <input
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-400 dark:border-gray-600 dark:placeholder-gray-400"
                                    aria-describedby="user_avatar_help" id="imageInput" type="file"
                                    name="profile_image" placeholder="foto profile" value="{{ old('profile_image') }}"
                                    onchange="previewImage(this)">
                                @if ($errors->has('profile_image'))
                                    <div class="block w-full text-sm text-red-800 dark:bg-gray-800 dark:text-red-400"
                                        role="alert">
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" id="website-admin" aria-label="disable input" name="email"
                                        class="rounded-none rounded-r-lg bg-gray-50 border border-purple-300 text-gray-900 focus:ring-purple-500 focus:border-purple-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                                        placeholder="dummy@gmail.com" value="{{ old('email') }}">
                                </div>
                                @if ($errors->has('email'))
                                    <div class="block w-full text-sm text-red-800 dark:bg-gray-800 dark:text-red-400" role="alert">
                                        {{ $errors->first('email') }}
                                ...
                                <div class="flex">
                                    <span
                                        ...
                                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                            ...
                                            viewBox="0 0 20 20" style="padding-left: 2px">
                                            <path
                                    ...
                                    <input type="password" id="website-admin" aria-label="disable input"
                                        name="password"
                                        class="rounded-none rounded-r-lg bg-gray-50 border border-purple-300 text-gray-900 focus:ring-purple-500 focus:border-purple-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                            ...
                            <div>
                                ...
                                <div class="flex mb-5">
                                    ...
                                    <input type="text" id="website-admin" aria-label="disable input"
                                        name="jabatan"
                                        class="rounded-none rounded-r-lg bg-gray-50 border border-purple-300 text-gray-900 focus:ring-purple-500 focus:border-purple-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                                        placeholder="Jabatan User" value="{{ old('jabatan') }}">
                                </div>
                            ...
                            <button type="submit"
                                class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800 mt-5">Buat
                                Akun</button>
                        </form>
                    </div>
                </div>
