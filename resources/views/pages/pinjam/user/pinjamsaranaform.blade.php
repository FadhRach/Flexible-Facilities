    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mb-6">
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-7 text-xl font-medium text-gray-900 dark:text-white">Pinjam Tempat</h3>
                <form method="POST" action="/pinjamsarana/store">
                    {{ csrf_field() }}
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="id_ruangan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Ruangan</label>
                        <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        type="hidden" name="id_ruangan" id="id_ruangan" value="{{ $ruangan->id_ruangan }}">
                        <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        type="text" required value="{{ $ruangan->nama_ruangan }}" disabled>
                    </div> 
                    <div class="mb-6">
