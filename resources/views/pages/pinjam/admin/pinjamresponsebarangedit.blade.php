    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mb-6">
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-7 text-xl font-medium text-gray-900 dark:text-white">Edit Pinjam Barang</h3>
                <form method="POST" action="/pinjamresponse/prasarana/update/{{ $pinjam_barang->id_pinjambarang }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="id_user" id="id_user" name="id_user"
                            ...
                            required value="{{ $pinjam_barang->user->name }}" disabled>
                    </div>                    
                    <div class="mb-6">
                        ...
                        <input type="nama_barang" id="nama_barang" name="nama_barang"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            required value="{{ $pinjam_barang->barang->nama_barang }}" disabled>
                    </div>
                    <div class="mb-6">
                        <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                        <input type="deskripsi" id="deskripsi" name="deskripsi"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            required value="{{ $pinjam_barang->deskripsi }}" disabled>
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="datetime-local" id="time_from" name="time_from" 
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" 
                            value="{{ date('Y-m-d\TH:i', strtotime($pinjam_barang->time_from)) }}">
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="datetime-local" id="time_to" name="time_to" 
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" 
                            value="{{ date('Y-m-d\TH:i', strtotime($pinjam_barang->time_to)) }}">
                    </div>
