    ...
    <body class="bg-green-50">
        ...
        <div class="p-4 sm:ml-64">
            ...
            <span class="flex item-center p-3 justify-center">
                <a href="/restored/restore" class="text-sm text-white dark:text-white p-2 bg-green-700 font-semibold rounded-md mr-3 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300">
                    Restore All
                </a>
            ...
            <div class="grid grid-cols-1 gap-4 mb-8">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <span href="#" class="flex items-center p-3 ml-3">
                        <h2 class="font-semibold text-green-800 text-2xl">Restore KIB D.</h2>
                    </span>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-1 py-4 text-right flex flex-auto">
                                    <a href="/restored/restore/{{ $item->id_kib_d }}" class="text-white dark:text-white p-1.5 bg-green-700 font-semibold rounded-md mr-3 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300">
                                        Restore
                                    </a>
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <a href="/restored/delete" class="text-sm text-white dark:text-white bg-red-600 font-semibold rounded-md hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 px-5 py-2.5 mr-2">
                                                Ya, Hapus semua
                                            </a>
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <a href="/restored/delete/{{ $item->id_kib_d }}" class="text-sm text-white dark:text-white bg-red-600 font-semibold rounded-md hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 px-5 py-2.5 mr-2">
                                                Ya, Hapus Data ini
                                            </a>
