    ...
    <body class="bg-purple-100">
        ...
        <div class="p-4 sm:ml-64">
            ...
            <div class="flex items-center justify-center mb-4 rounded bg-gray-50 dark:bg-gray-800">
                <form class="p-3" action="/hapusdata/kibb/store" method="POST">
                    @csrf
                    <div class="space-y-12 p-5">
                      <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <span href="#" class="lg:flex md:flex items-center mt-10 justify-center hidden">
                            ...
                            <h2 class="font-semibold text-purple-950 text-xl ml-2">Form Penghapusan KIB B.</h2>
                        </span>
                          ...
                          <div class="sm:col-span-full">
                            ...
                            <div class="mt-2">
                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                <input type="text" name="nama" class="block flex-1 border-0 bg-transparent py-1.5 p-2 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{ $kibb->nama_barang }}" readonly>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6 p-5">
                        ...
                        @endif
                        @if(session('success'))
                            <a href="/truehapus/kibb/{{ $kibb->id_barang }}" class="font-medium text-gray-50 bg-red-700 p-1.5 rounded-md">
                                Hapus Data
                            </a>
                        @endif
                    </div>
