    ...
    <body class="bg-purple-100">
        ...
        <div class="p-4 sm:ml-64">
            ...
            <div class="flex items-center justify-center mb-4 rounded bg-gray-50 dark:bg-gray-800">
                <form class="p-3" action="/kib-b/store" method="POST">
                    @csrf
                    <div class="space-y-12 p-5">
                      <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <span href="#" class="flex items-center mt-10 justify-center">
                            ...
                            <h2 class="font-semibold text-purple-950 text-xl ml-2">Form Data KIB B.</h2>
                        </span>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-6">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                    ...
                                    <select name="id_gudang"
                                            ...
                                            <option selected disable class="text-gray-500">Nama Barang</option>
                                            @foreach ($relgud as $r)
                                            <option value="{{ $r->id_gudang }}" data-nama="{{ $r->nama_barang }}">{{ $r->nama_barang }} - {{ $r->register }}</option>
                                            @endforeach
                                    </select>
                                    <!-- Input tersembunyi untuk menyimpan nilai nama_barang -->
                          ...
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                <input type="text" name="nomor_unik" class="block flex-1 border-0 bg-transparent py-1.5 p-2 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Masukkan Nomor Unik">
                              </div>
                            </div>
                          </div>

                          <div class="sm:col-span-3">
                            <label for="id_ruangan" class="block text-sm font-medium leading-6 text-gray-900">Nama Ruangan</label>
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                    <select name="id_ruangan"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500">
                                            <option selected disable class="text-gray-500">Pilih Ruangan</option>
                          ...
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                <input type="Number" name="tahun" class="block flex-1 border-0 bg-transparent py-1.5 p-2 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Masukkan Tahun">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                <input type="number" name="nilai" class="block flex-1 border-0 bg-transparent py-1.5 p-2 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Masukkan Nilai">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                              <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-purple-800 sm:max-w-md bg-white">
                                <input type="number" name="akumulasi" class="block flex-1 border-0 bg-transparent py-1.5 p-2 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Masukkan Akumulasi">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-span-full">
                            ...
                            <div class="mt-2">
                              <textarea name="keterangan" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-800 sm:text-sm sm:leading-6" placeholder="Masukkan Keterangan"></textarea>
                            </div>
                          </div>
        ...
        <script>
            // Menggunakan jQuery untuk menangani perubahan pada dropdown
            $(document).ready(function(){
                // Menangani perubahan pada dropdown
                $('select[name="id_gudang"]').on('change', function(){
                    // Mengambil nilai 'nama' dari atribut data-nama
                    var nama_barang = $('option:selected', this).data('nama');
                    // Menetapkan nilai nama_barang ke dalam input tersembunyi
