    ...
    <body class="bg-purple-100">
        ...
        <div class="p-4 sm:ml-64">
            ...
            <span href="#" class="flex items-center p-1 justify-center mr-6 mt-10">
                ...
                <h2 class="font-semibold text-purple-800 text-2xl">Data KIB D.</h2>
            </span>
            ...
            <div class="grid grid-cols-1 gap-4 mb-8">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <span href="#" class="flex items-center p-3 ml-3">
                        <h2 class="font-semibold text-purple-800 text-2xl">Pemutahiran Data KIB D.</h2>
                    </span>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <a href="/pemutahirandata/kibd/{{ $s->id_kib_d }}">
